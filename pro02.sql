...
pw varchar2(300) not null, name varchar2(20), tel varchar2(20),
...
create table product1(pcode varchar2(8) primary key,
...
-- 상품 이미지 필드 추가
alter table product1 add pic1 varchar2(200);
alter table product1 add pic2 varchar2(200);
alter table product1 add pic3 varchar2(200);
insert into product1 values ('4192','시장학 개론','149X210X36',25000,'스노우폭스북스 · 2023년 04월 19일',10,'./img/4192.jpg','./img/4192_1.jpg','./img/4192_2.jpg');
insert into product1 values ('6186','살 때, 팔 때, 벌 때','152X225',22000,'21세기북스 · 2023년 02월 28일',12,'./img/6186.jpg','./img/6186_1.jpg','./img/6186_2.jpg');
insert into product1 values ('5072','흔한 남매 13','148X210',14500,'미래엔아이세움 · 2023년 04월 25일',8,'./img/5072.jpg','./img/5072_1.jpg','./img/5072_2.jpg');
insert into product1 values ('1352','고래','153X224X35',15000,'문학동네 · 2014년 04월 16일',13,'./img/1352.jpg','./img/1352_1.jpg','./img/1352_2.jpg');
insert into product1 values ('8138','파이썬 데이터 분석','183X235',39000,'한빛미디어 · 2023년 05월 01일',5,'./img/8138.jpg','./img/8138_1.jpg','./img/8138_2.jpg');
insert into product1 values ('8162','Servlet&JSP 프로그래밍','170X232X28',27000,'쌤즈 · 2022년 09월 19일',6,'./img/8162.jpg','./img/8162_1.jpg','./img/8162_2.jpg');
alter table product1 add utburl varchar2(500);       -- 유튜브 링크 추가
update product1 set utburl='https://www.youtube.com/embed/oVOcPt4eR9A' where pcode='4192';
update product1 set utburl='https://www.youtube.com/embed/qL3umFVNCU0' where pcode='6186';
update product1 set utburl='https://www.youtube.com/embed/YINtNRMGwQs' where pcode='5072';
update product1 set utburl='https://www.youtube.com/embed/hIpfM5QqZhA' where pcode='1352';
update product1 set utburl='https://www.youtube.com/embed/c0s_QYrsXZs' where pcode='8138';
update product1 set utburl='https://www.youtube.com/embed/x1wBBms7n9w' where pcode='8162';
alter table product1 add bookidx varchar2(1000);     -- 목차 추가
update product1 set bookidx='1장 가장 현실적이며 시급하게 묻다<br>2장 더 단단한 사장이 되는데 필요한 생각에 대한 ‘생각’<br>3장 직원 - 그들은 누구인가!<br>4장 사업을 넘어 기업으로<br>5장 자신만의 철학을 세워라<br>6장 사장이 되기로 결심한 그대' where pcode='4192';
update product1 set bookidx='PART 1 연금술에 빠진 개미들, 법칙이 아닌 원칙이 필요하다<br>PART 2 지표에 근거한 투자 전략<br>PART 3 무엇이든 살 수 있는 시장에서 뭘 사야 할지 모르는 투자자들<br>PART 4 투자, 채워가는 것이 아닌 비워내는 과정' where pcode='6186';
update product1 set bookidx='01화 내 방에서 나가라고~!<br>02화 방학 막바지에 이런 사람 꼭 있다!<br>03화 서프라이즈 장난 대결<br>04화 흔한남매, 반 배정 망하다?!<br>05화 오싹오싹 폭풍 공감 이야기<br>06화 소풍 도시락 싸기 대작전!<br>07화 으뜸이를 위한 K-참교육!<br>08화 오빠 친구, 장민철<br>09화 꿈속의 꿈속의 꿈속의 꿈?!<br>10화 데이지의 성장 앨범<br>11화 바둑이를 찾습니다!' where pcode='5072';
update product1 set bookidx='1부 부두<br>2부 평대<br>3부 공장<br><br>심사평<br><br>수상작가 인터뷰 : 이야기, 혹은 소설의 미래<br>수상소감' where pcode='1352';
update product1 set bookidx='CHAPTER 1 시작하기 전에<br>CHAPTER 2 파이썬 기초, Ipython과 주피터 노트북<br>CHAPTER 3 내장 자료구조, 함수, 파일<br>CHAPTER 4 넘파이 기본: 배열과 벡터 연산<br>CHAPTER 5 판다스 시작하기<br>CHAPTER 6 데이터 로딩과 저장, 파일 형식<br>CHAPTER 7 데이터 정제 및 준비<br>CHAPTER 8 데이터 준비하기: 조인, 병합, 변형<br>CHAPTER 9 그래프와 시각화<br>CHAPTER 10 데이터 집계와 그룹 연산<br>CHAPTER 11 시계열<br>CHAPTER 12 파이썬 모델링 라이브러리<br>CHAPTER 13 데이터 분석 예제<br>APPENDIX A 고급 넘파이<br>APPENDIX B IPython 시스템 더 알아보기' where pcode='8138';
update product1 set bookidx='01장 개발 환경 설정<br>02장 HTTP 프로토콜과 요청 방식<br>03장 서블릿 객체와 라이프 사이클<br>04장 JDBC 프로그래밍<br>05장 사용자 요청 처리<br>06장 서블릿 핵심 객체<br>07장 서블릿을 이용한 게시판 구현<br>08장 상태 정보 유지<br>09장 서블릿 객체와 정보 공유<br>10장 필터와 리스너<br>11장 JSP 개요 및 스크립트 기반 태그<br>12장 내장 객체와 게시판 프로그램 구현<br>13장 MVC 디자인 패턴 적용<br>14장 MVC 프레임워크 적용<br>15장 EL과 JSTL<br>' where pcode='8162';
