		...
		<table class="table">
			...
			<tbody>
				...
				<tr>
					...
					<td>${bas.amount }</td>
					<td>
						<a href="${path1 }/AddSales.do?bnum=${bas.bnum }&pcode=${bas.pcode }&amount=${bas.amount }&id=${sid }" class="btn btn-primary">구매</a>
						<a href="${path1 }/DeleteBasket.do?bnum=${bas.bnum }" class="btn btn-danger">삭제</a>
