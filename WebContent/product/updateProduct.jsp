			...
			<table class="table">
				<tbody>
					...
					<tr>
						...
						<td>
							<input type="text" name="pname" id="pname" value="${pro.pname }" title="40자 내로 작성" placeholder="40자 내로 작성" class="form-control" required>
					...
					<tr>
						...
						<td>
							...
							이미지 2 : 
							<p id="picAttac2"><img src='${path1 }/product/${pro.pic2 }' alt="${pro.pname }"/></p>
							<p></p>
							...
							이미지 3 : 
							<p id="picAttac3"><img src='${path1 }/product/${pro.pic3 }' alt="${pro.pname }"/></p>
							<p></p>
