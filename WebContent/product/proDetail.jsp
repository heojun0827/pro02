					...
					<td colspan="2">
						<div class="btn-group">
							<c:if test="${pro.amount>0 && !sid.equals('admin')}">
								<a href="${path1 }/InsertBasket.do?pcode=${pro.pcode}" class="btn btn-primary" role="button">장바구니</a>
							...
							<c:if test="${sid.equals('admin') }">
								<a href="${path1 }/ReceiptProduct.do?pcode=${pro.pcode }" class="btn btn-primary" role="button">입고</a>
